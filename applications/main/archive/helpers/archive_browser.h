...
static const char* tab_default_paths[] = {
    ...
    [ArchiveTabIButton] = EXT_PATH("apps/Games"),
    [ArchiveTabNFC] = EXT_PATH("apps/Games"),
    [ArchiveTabSubGhz] = EXT_PATH("subghz"),
    [ArchiveTabLFRFID] = EXT_PATH("apps/Games"),
    [ArchiveTabInfrared] = EXT_PATH("infrared"),
    [ArchiveTabBadKb] = EXT_PATH("badkb"),
    [ArchiveTabU2f] = EXT_PATH("apps/Games"),
    [ArchiveTabApplications] = EXT_PATH("apps/Games"),
    [ArchiveTabSearch] = EXT_PATH("apps/Games"),
