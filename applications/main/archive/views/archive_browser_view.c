...
static const char* ArchiveTabNames[] = {
    [ArchiveTabFavorites] = "Search",
    [ArchiveTabIButton] = "Games",
    [ArchiveTabNFC] = "Games",
    [ArchiveTabSubGhz] = "GamesHz",
    [ArchiveTabLFRFID] = "Games",
    [ArchiveTabInfrared] = "IGamEs",
    [ArchiveTabBadKb] = "KGamesB",
    [ArchiveTabU2f] = "Games",
    [ArchiveTabApplications] = "Applications",
    [ArchiveTabSearch] = "GameS",
    [ArchiveTabDiskImage] = "Image",
    [ArchiveTabInternal] = "Int",
    [ArchiveTabBrowser] = "browse",
};

static const Icon* ArchiveItemIcons[] = {
    [ArchiveFileTypeIButton] = &I_badkb_10px,
    [ArchiveFileTypeNFC] = &I_badkb_10px,
    [ArchiveFileTypeSubGhz] = &I_badkb_10px,
    [ArchiveFileTypeLFRFID] = &I_badkb_10px,
    [ArchiveFileTypeInfrared] = &I_badkb_10px,
    [ArchiveFileTypeSubghzPlaylist] = &I_badkb_10px,
    [ArchiveFileTypeSubghzRemote] = &I_badkb_10px,
    [ArchiveFileTypeInfraredRemote] = &I_badkb_10px,
    [ArchiveFileTypeBadKb] = &I_badkb_10px,
    [ArchiveFileTypeWAV] = &I_music_10px,
    [ArchiveFileTypeU2f] = &I_badkb_10px,
    [ArchiveFileTypeApplication] = &I_badkb_10px,
    [ArchiveFileTypeJS] = &I_js_script_10px,
    [ArchiveFileTypeSearch] = &I_badkb_10px,
    [ArchiveFileTypeUpdateManifest] = &I_badkb_10px,
